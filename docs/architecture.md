...
Leaflet and OpenStreetMap provide the public map and map picker without Google Maps billing. Recharts renders admin analytics once issue data exists.
...
11. Admin analytics reads limited issue columns and status-history rows, then renders charts in client components.
